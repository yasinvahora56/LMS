...
<body>
    ...
    <div class="form-group">
                ...
                <input type="text" class="form-control" id="author_name" name="author_name" value="<?php echo ($author_name); ?>" required>
            </div>
...
if (isset($_POST['add_author'])) {
    ...
    if ($query_run) {
        ...
        $author_name = ''; // Clear the variable after successful insert
    } else {
