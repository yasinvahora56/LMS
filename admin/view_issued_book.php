        ...
        <div class="col-md-8">
            <form action="">
                <table class="table-bordered" width="900px" style="text-align: center";>
                    <tr>
                        <th style="background-color:#343A40";><font style="color:white";>Books name:</font></th>
                        <th style="background-color:#343A40";><font style="color:white";>Authors name:</font></th>
                        <th style="background-color:#343A40";><font style="color:white";>Book Number:</font></th>
                        <th style="background-color:#343A40";><font style="color:white";>Student Name:</font></th>
                    </tr>
                    <?php
