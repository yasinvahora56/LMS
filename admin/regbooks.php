            ...
            <form action="">
                <table class="table-bordered" width="900px" style="text-align: center";>
                    <tr>
                        ...
                        <th style="background-color:#343A40";><font style="color:white";>Author:</font></th>
                        <th style="background-color:#343A40";><font style="color:white";>price:</font></th>
                        <th style="background-color:#343A40";><font style="color:white";>Number:</font></th>
                    </tr>
                    <?php
