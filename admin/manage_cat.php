    ...
    <div class="row">
			...
			<div class="col-md-8">
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
                        <th style="background-color:#343A40; color:azure">Category Name</th>
                ...
                <?php
					...
					while ($row = mysqli_fetch_assoc($query_run)) {
                        ...
                        <tr style="background-color:#e3f2fd";>
                            <td style="font-family:verdana"><?php echo $row['cat_name']?></td>
                            <td style="text-align:left;";><button class="btn btn-dark"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>" style="color:aliceblue;">Edit</a></button>
                            <button class="btn btn-dark" herf="delete.php"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>" style="color:aliceblue;">Delete</a></button></td>
                        </tr>
                        <?php
						}
					?>
